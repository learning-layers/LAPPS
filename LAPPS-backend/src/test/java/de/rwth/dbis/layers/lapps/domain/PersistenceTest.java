...
public class PersistenceTest {
  ...
  public void initData() {
    ...
    app.addArtifact(new Artifact("image", Utils.generateRandomInt(0, 3000) + "@image.com"));
    app.addTag(new Tag("tag_" + Utils.generateRandomInt(0, 3000)));
    app.addTag(new Tag("tag_" + Utils.generateRandomInt(0, 3000)));
  ...
  private void modified(App a) {
    // modify/update data:
    a.setName("modified");
    a.addArtifact(new Artifact("image", Utils.generateRandomInt(0, 3000) + "@image.com"));
    a.addTag(new Tag("tag_" + Utils.generateRandomInt(0, 3000)));
    a = facade.save(a);
